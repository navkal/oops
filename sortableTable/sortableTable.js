          ...
          if ( tRule.columnType == 'control' )
          {
            ...
            switch ( tRule.controlType )
            {
              ...
              case 'update':
                ...
                sCell += '<button class="btn btn-link btn-xs" onclick="initUpdateDialog('+"'"+sCellValue+"'"+')" data-target="#editDialog" data-toggle="modal" data-backdrop="static" ' + tRule.customizeButton( sCellValue ) + '>';
