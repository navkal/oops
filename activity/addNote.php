<?php
  ...
  $command = quote( getenv( "PYTHON" ) ) . " ../database/saveNotes.py 2>&1 -u " . $_SESSION['panelSpy']['user']['username'] . " -t " . $_POST['object_type'] . " -i " . $_POST['object_id'] . " -n " . quote( $_POST['note'] ) . $g_sContext;
