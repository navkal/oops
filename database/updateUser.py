...
if __name__ == '__main__':
    ...
    try:
        status = sql.updateUser( args.by, args.username, args.oldPassword, args.password, args.role, args.auth_facilities, args.status, args.first_name, args.last_name, args.email_address, args.organization, args.description, args.enterprise )
    except:
