...
if __name__ == '__main__':
    ...
    try:
        status = sql.restoreRemovedObject( args.by, args.id, args.parent_id, args.phase_b_parent_id, args.phase_c_parent_id, args.tail, args.room_id, args.enterprise, args.facility )
    except:
