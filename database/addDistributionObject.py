...
if __name__ == '__main__':
    ...
    try:
        status = sql.addDistributionObject( args.by, args.object_type, args.parent_id, args.phase_b_parent_id, args.phase_c_parent_id, args.tail, args.voltage_id, args.three_phase, args.room_id, args.description, args.filename, args.enterprise, args.facility )
    except:
